...
{
//	RCC_APB2PeriphClockCmd(RCC_VL53L0x, ENABLE); // 使能GPIO时钟
//	
...
//	GPIO_Init(PORT_VL53L0x, &GPIO_InitStructure);
	gpio_config(GPIOA,GPIO_Pin_9,GPIO_Mode_Out_OD,GPIO_Speed_50MHz);
	gpio_config(GPIOA,GPIO_Pin_10,GPIO_Mode_Out_OD,GPIO_Speed_50MHz);
