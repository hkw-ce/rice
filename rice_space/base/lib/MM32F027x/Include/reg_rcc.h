...
#define RCC_CFGR2_LPTIMSEL_Msk          (0x03U << RCC_CFGR2_LPTIMSEL_Pos)       ///< LPTIM clock source select mask
...
#define RCC_CFGR2_LPTIMSEL_PCLK         (0x02U << RCC_CFGR2_LPTIMSEL_Pos)       ///< LPTIM clock source select PCLK
