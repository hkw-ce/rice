...
typedef struct {
    ...
    __IO u32  IER;                                                              ///< interrupt enable register                                    offset: 0x04
    __IO u32  ISR;                                                              ///< interrupt flag register                                      offset: 0x08
    __IO u32  CR;                                                               ///< control register                                             offset: 0x0C
    __IO u32  CNT;                                                              ///< count register                                               offset: 0x10
    __IO u32  CMP;                                                              ///< compare value register                                       offset: 0x14
    __IO u32  TARGET;                                                           ///< target value register                                        offset: 0x18
} LPTIM_TypeDef;
...
#define LPTCFG_FLTEN                    (0x01U << LPTCFG_FLTEN_Pos)             ///< Input signal filtering enable
...
#define LPTCFG_TRIGSEL                  (0x01U << LPTCFG_TRIGSEL_Pos)           ///< COMP input trigger
#define LPTCFG_POLARITY_Pos             (4)
#define LPTCFG_POLARITY                 (0x01U << LPTCFG_POLARITY_Pos)          ///< Compare waveform polarity select
...
#define LPTCFG_MODE                     (0x01U << LPTCFG_MODE_Pos)              ///< Counting mode
...
////////////////////////////////////////////////////////////////////////////////
#define LPTCNT_CNT_VAL_Pos              (0)
#define LPTCNT_CNT_VAL                  (0xFFFFU << LPTCNT_CNT_VAL_Pos)         ///<  counter count value
