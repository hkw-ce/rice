...
typedef struct {
    ...
    __IO u32 LPUMODU;                                                           ///< Baud rate module control register                 offset: 0x04
    ...
    __IO u32 WKCKE;                                                             ///< Wakeup  register                                  offset: 0x20
} LPUART_TypeDef;
...
////////////////////////////////////////////////////////////////////////////////
#define LPUART_LPUMODU_MCTL_Pos         (0)
#define LPUART_LPUMODU_MCTL             (0xFFFU << LPUART_LPUMODU_MCTL_Pos)        ///< Bit modulation control signal
...
////////////////////////////////////////////////////////////////////////////////
#define LPUART_COMPARE_DATA_Pos         (0)
#define LPUART_COMPARE_DATA             (0xFFU << LPUART_COMPARE_DATA_Pos)      ///< compare data

////////////////////////////////////////////////////////////////////////////////
/// @brief LPUART_WKCKE Register Bit Definition
////////////////////////////////////////////////////////////////////////////////
#define LPUART_WKCKE_WKUP_MODE_Pos      (0)
#define LPUART_WKCKE_WKUP_MODE          (0x01U << LPUART_WKCKE_WKUP_MODE_Pos)   ///< Wakeup mode setting
