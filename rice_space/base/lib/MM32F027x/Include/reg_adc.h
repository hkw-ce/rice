...
typedef struct {
    ...
    __IO u32 RESERVED0x94;                                                      ///< Reserved register                              offset: 0x94
    __IO u32 RESERVED0x98;                                                      ///< Reserved register                              offset: 0x98
